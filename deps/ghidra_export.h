...
namespace MH {
  ...
  namespace Quest {
    ...
    static undefined(*GetStarCount)() = (undefined(*)())0x141975570;
    namespace QuestData {
  ...
  namespace GuidingLands {
    static void(*AddRegionXp)(longlong,int,int) = (void(*)(longlong,int,int))0x141347ef0;
    static char(*GetRegionLevel)(longlong,int) = (char(*)(longlong,int))0x141353080;
    static undefined8(*MaxXpForLevel)(undefined4) = (undefined8(*)(undefined4))0x141353150;
    static uint(*GetLevelProgressPercentage)(longlong,int) = (uint(*)(longlong,int))0x1413531b0;
    static void(*RegionLevelChangeNotif)(longlong,undefined4,undefined4,undefined4) = (void(*)(longlong,undefined4,undefined4,undefined4))0x141a54680;
    namespace LowerUI {
      static void(*LowerRegion)(longlong,int) = (void(*)(longlong,int))0x140553080;
      static void(*Init_)(longlong,longlong *) = (void(*)(longlong,longlong *))0x140552950;
      static void(*Init)(longlong,int,undefined4,int,undefined4,undefined4,int) = (void(*)(longlong,int,undefined4,int,undefined4,undefined4,int))0x141e85880;
    }
  }
}
